...
import { useDeleteComment } from "@/features/chapters/api"
...
export function CommentItem({ comment, chapterId, depth = 0 }: CommentItemProps) {
  ...
  // Removed comments keep their place (and their replies) but show only a muted
  // "[deleted]" placeholder in lieu of the author and content.
  if (isRemoved) {
    return (
